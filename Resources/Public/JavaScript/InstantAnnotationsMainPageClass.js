define(['TYPO3/CMS/IaPluginTypo3/moment',
        ...
        "TYPO3/CMS/IaPluginTypo3/InstantAnnotationsMainPage"],
    function (InstantAnnotations) {
        var InstantAnnotationsMainPage = {
            foo: 'bar'
        };

        InstantAnnotationsMainPage.init = function () {


            InstantAnnotations.IAsemantify_Init();

            //on change function moved here
...
//var existingAnnotationsString = <?php echo json_encode( get_post_meta( get_the_ID(), $this->plugin_name . "_ann_id", true ) );?>;
        ...
        return InstantAnnotationsMainPage;
    });
