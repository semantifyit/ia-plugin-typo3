define(['TYPO3/CMS/IaPluginTypo3/moment',
        'TYPO3/CMS/IaPluginTypo3/jquery.min',
        'TYPO3/CMS/IaPluginTypo3/datetimepicker',
        'TYPO3/CMS/IaPluginTypo3/bootstrap',
        'TYPO3/CMS/IaPluginTypo3/snackbar',
        'TYPO3/CMS/IaPluginTypo3/iasemantify-admin',
        'TYPO3/CMS/IaPluginTypo3/iasemantify-login',
        'TYPO3/CMS/IaPluginTypo3/instantAnnotations'
    ],
    function () {

        var InstantAnnotations = {
...
//semantifyShortUrl = "https://staging.semantify.it/api/annotation/short/";
        ...
        InstantAnnotations.IAsemantify_Init = function() {
        ...
        function getDesc(propertyName) {
            return stripHtml(iasemantify_sdoProperties[propertyName]["description"]);
        }
        ...
        InstantAnnotations.httpGet = function (url, callback){
